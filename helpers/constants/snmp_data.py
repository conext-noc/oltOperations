SNMP_OIDS={
    ...
    "POWER_RX_OLT":"1.3.6.1.4.1.2011.6.128.1.1.2.51.1.6",
...
LAST_DOWN_CAUSE = {
    ...
    "4":"SFI",
    "5":"LOAI",
    "7":"deactive fails",#deactive fails
    "8":"deactive success",#deactive success
    "9":"reset ONT",
    "13":"dying-gasp",
    "31":"reset by command",#reset by command
    "33":"reset by software",#reset by software
}
map_ports = {
